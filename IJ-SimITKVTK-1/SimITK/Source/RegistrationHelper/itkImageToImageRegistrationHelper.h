...
class ImageToImageRegistrationHelper : public Object
  ...
  public:
    ...
    const ImageType *GetFinalMovingImage( InterpolationMethodEnumType interp=OptimizedRegistrationMethodType::LINEAR_INTERPOLATION );

    const ImageType *GetFixedToFinalMovingDifferenceImage( InterpolationMethodEnumType interp=OptimizedRegistrationMethodType::LINEAR_INTERPOLATION );
